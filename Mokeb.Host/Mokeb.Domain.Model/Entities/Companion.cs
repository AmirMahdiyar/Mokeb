...
namespace Mokeb.Domain.Model.Entities
{
    ...
    {
        public Companion(string name, string familyName, string nationalNumber, DateOnly dateOfBirth, string phoneNumber, Gender gender, string passportNumber, Guid principalId)
        {
            CheckName(name);
